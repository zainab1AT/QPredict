...
import { healthUpdates } from "../Scripts/reviews";
import "../Styles/Reviews.css";

function Reviews() {
  let rMessage, rName, rLocation;
  const reviewsLength = healthUpdates.length - 1;
  ...
  const handleReviewsUpdation = () => {
    const reviewMessage = healthUpdates[review];
    rName = reviewMessage.title;
    rLocation = reviewMessage.description;
    rMessage = reviewMessage.details;
  };
  ...
  return (
    <div className="review-section" id="reviews">
      <div className="rw-text-content">
       ...
       <span className="rw-text-num">Daily</span> Health Alerts for your region
        </p>
